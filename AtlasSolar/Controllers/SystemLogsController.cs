...
namespace AtlasSolar.Controllers
{
    public class SystemLogsController : Controller
    {
        ...
        //public async Task<ActionResult> Create([Bind(Include = "Id,DateTime,UserId,User,Operation,Action,Comment")] SystemLog systemLog)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> Edit([Bind(Include = "Id,DateTime,UserId,User,Operation,Action,Comment")] SystemLog systemLog)
        //{
        //    if (ModelState.IsValid)
        //    {
